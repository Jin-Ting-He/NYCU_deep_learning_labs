...
#mask_b: iteration decoding initial mask, where mask_b is true means mask
    def inpainting(self,image,mask_b,i): #MakGIT inference
        ...
        with torch.no_grad():
            ...
            z_indices_predict=z_indices.to(device=self.device)
            mask_bc=mask_b
...
#TODO3 step1-2: modify the path, MVTM parameters
    parser.add_argument('--load-transformer-ckpt-path', type=str, default='./checkpoints/v5/transformer_epoch_100.pt', help='load ckpt')
