...
class Test_model(VAE_Model):
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        for i in range(1, self.val_vi_len):
            ...
            feature_label = self.label_transformation(label[i])
            feature_img = self.frame_transformation(out)

            parm = self.Decoder_Fusion(feature_img, feature_label, z)    
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path',     type=str,    default="Cyclical_ext/best.ckpt",help="The path of your checkpoints")   
